...
import { Button, Form, Input, DatePicker, Table, Radio, Popconfirm, Switch } from "antd";
  ...
  return (
    ...
    >
      <Form
        ...
        wrapperCol={{ span: 14 }}
      >
        <Form.Item name="noticename" label="用户名称" rules={rules.noticename}>
  ...
  const columns = [
    {
      ...
      key: "noticeType",
      render: (value, record) => <>{value ? "通知" : "公告"}</>,
    },
